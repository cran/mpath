...
###################################################
### code chunk number 1: german.Rnw:31-33
###################################################
...
###################################################
### code chunk number 2: german.Rnw:39-43
###################################################
library("mpath")
library("zic")
#library("pscl")
...
###################################################
### code chunk number 5: german.Rnw:56-61 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 6: german.Rnw:64-68 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 7: german.Rnw:71-72 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: german.Rnw:75-78 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 9: german.Rnw:81-82 (eval = FALSE)
###################################################
## se(fit.lasso, minBic, log=FALSE)


###################################################
### code chunk number 10: german.Rnw:85-88 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 11: german.Rnw:91-99 (eval = FALSE)
###################################################
## n <- dim(dat)[1]
## K <- 10
## set.seed(197)
...
###################################################
### code chunk number 12: german.Rnw:104-106 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 13: german.Rnw:109-112 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 14: german.Rnw:115-116 (eval = FALSE)
###################################################
## se(fit.mcp, minBic, log=FALSE)


###################################################
### code chunk number 15: german.Rnw:119-122 (eval = FALSE)
###################################################
## AIC(fit.mcp)[minBic]
## BIC(fit.mcp)[minBic]
...
###################################################
### code chunk number 16: german.Rnw:125-129 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 17: german.Rnw:133-135 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 18: german.Rnw:138-141 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 19: german.Rnw:144-145 (eval = FALSE)
###################################################
## se(fit.scad, minBic, log=FALSE)


###################################################
### code chunk number 20: german.Rnw:148-151 (eval = FALSE)
###################################################
## AIC(fit.scad)[minBic]
## BIC(fit.scad)[minBic]
...
###################################################
### code chunk number 21: german.Rnw:154-158 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 22: german.Rnw:161-162 (eval = FALSE)
###################################################
## print(proc.time()-ptm)
