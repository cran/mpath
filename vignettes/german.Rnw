...
%\VignetteIndexEntry{Variable Selection for Health Care Demand in Germany (Short)}
%\VignetteDepends{zic}
...
This document reproduces the data analysis presented in
\cite{wang2014zinb}. For a description of the theory behind
